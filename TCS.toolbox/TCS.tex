...
See DISC\mbox{'}2018: Multi-Shot Distributed Transaction Commit
\end{cpar}%
\end{lcom}%
...
\@pvspace{8.0pt}%
 ...
 Cardinality ( Tid )\@s{12.29}}%
\@y{\@s{0}%
 with a distinguished minimum version 0
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}} Slot \.{\defeq} 1
 \.{\dotdot} Cardinality ( Tid )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}} TKey ( t ) \.{\defeq} WSet [
 t ] \.{\cup} \{ kv [ 1 ] \.{:} kv \.{\in} RSet [ t ] \}}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}} TSharding \.{\defeq} [ t
 \.{\in} Tid \.{\mapsto} \{ KeySharding [ k ] \.{:} k \.{\in} TKey ( t ) \}
 ]}%
\@pvspace{8.0pt}%
...
\@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{16.4} next ,\,\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{next[s] \.{\in} Z} points to the last filled slot
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{16.4} txn ,\,\@s{8.88}}%
\@y{\@s{0}%
 \ensuremath{txn[s][i]} is the transaction (identifier) to certify in the
 \ensuremath{i}-th slot
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{16.4} vote ,\,\@s{4.84}}%
\@y{\@s{0}%
 \ensuremath{vote[s][i]} is the vote for \ensuremath{txn[s][i]
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{16.4} dec ,\,\@s{8.86}}%
\@y{\@s{0}%
 \ensuremath{dec[s][i]} is the decision for \ensuremath{txn[s][i]
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{16.4} phase\@s{4.56}}%
\@y{\@s{0}%
 \ensuremath{phase[s][i]} is the phase for \ensuremath{txn[s][i]
}}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}} vars \.{\defeq} {\langle}
 next ,\, txn ,\, vote ,\, dec ,\, phase {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}} TypeOK \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 next \.{\in} [ Shard \.{\rightarrow} Int ]}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 txn \.{\in} [ Shard \.{\rightarrow} [ Slot \.{\rightarrow} Tid \.{\cup} \{
 NotTid \} ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
...
\@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}} Init \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{16.4} \.{\land} next
 \.{=} [ s \.{\in} Shard \.{\mapsto} \.{-} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{16.4} \.{\land} txn \.{=}
 [ s \.{\in} Shard \.{\mapsto} [ i \.{\in} Slot \.{\mapsto} NotTid ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{16.4} \.{\land} vote
 \.{=} [ s \.{\in} Shard \.{\mapsto} [ i \.{\in} Slot \.{\mapsto}\@w{NULL} ]
 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{16.4} \.{\land} dec \.{=}
 [ s \.{\in} Shard \.{\mapsto} [ i \.{\in} Slot \.{\mapsto}\@w{NULL} ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{16.4} \.{\land} phase
 \.{=} [ s \.{\in} Shard \.{\mapsto} [ i \.{\in} Slot \.{\mapsto}\@w{START} ]
 ]}%
\@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}} Certify ( t ,\, s )
 \.{\defeq}}%
\@y{\@s{0}%
 Cerify \ensuremath{t \.{\in} Tid} on shard \ensuremath{s \.{\in} Shard
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{16.4} \.{\land}\@s{3.65}
 {\FALSE}}%
\@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}} Next \.{\defeq} {\TRUE}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}} Spec\@s{1.46} \.{\defeq}
 Init \.{\land} {\Box} [ Next ]_{ vars}}%
\@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 10:22:37 \ensuremath{CST} 2021 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%

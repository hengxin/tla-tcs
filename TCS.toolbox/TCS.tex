...
\@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}}\@s{16.4} Key ,\,\@s{24.58}}%
\@y{\@s{0}%
 the set of keys, ranged over by \ensuremath{k \.{\in} Key
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}}\@s{16.4} Val ,\,\@s{27.24}}%
\@y{\@s{0}%
 the set of values, ranged over by \ensuremath{v \.{\in} Val
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}}\@s{16.4} Trans
 ,\,\@s{16.87}}%
\@y{\@s{0}%
 the set of transactions, ranged over by \ensuremath{t \.{\in} Trans
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}\@s{16.4} Shard
 ,\,\@s{16.91}}%
\@y{\@s{0}%
 the set of shards, ranged over by \ensuremath{s \.{\in} Shard
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}\@s{16.4} Client
 ,\,\@s{15.34}}%
\@y{\@s{0}%
 the set of clients, ranged over by \ensuremath{c \.{\in} Client
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}}\@s{16.4} TxCoord
 ,\,\@s{4.09}}%
\@y{\@s{0}%
 \ensuremath{TxCoord(t)} is the coordinator of \ensuremath{t \.{\in} Trans
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}\@s{16.4}
 KeySharding\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{KeySharding(k)} is the shard that holds \ensuremath{k \.{\in} Key
}}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}} Slot \.{\defeq} 1
 \.{\dotdot} Cardinality ( Trans )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}} NotVal \.{\defeq} {\CHOOSE}
 v \.{:} v \.{\notin} Val}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}} NotTrans \.{\defeq}
 {\CHOOSE} t \.{:} t \.{\notin} Trans}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}} {\ASSUME}}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{16.4} \.{\land} TxCoord
 \.{\in} [ Trans \.{\rightarrow} Shard ]}%
...
\@y{\@s{2.5}%
 \ensuremath{\.{\land} \A\, t \.{\in} Trans}:
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}} Op \.{\defeq} [ type \.{:}
 \{\@w{read} ,\,\@w{write} \} ,\, key \.{:} Key ,\, val \.{:} Val ]}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}} R ( k ,\, v )\@s{4.14}
 \.{\defeq} [ type \.{\mapsto}\@w{read} ,\, key \.{\mapsto} k ,\, val
 \.{\mapsto} v ]}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}} W ( k ,\, v ) \.{\defeq} [
 type \.{\mapsto}\@w{write} ,\, key \.{\mapsto} k ,\, val \.{\mapsto} v ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}} {\ASSUME}}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{16.4} \.{\land} Trans
 \.{\in} Seq ( Op )\@s{4.1}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}} RS ( t ) \.{\defeq} \{ op .
 key \.{:} op \.{\in} Range ( t ) \}}%
...
\@y{\@s{0}%
 \ensuremath{txn[s][i]} is the transaction to certify in the
...
\@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}} TypeOK \.{\defeq}}%
 ...
 txn \.{\in} [ Shard \.{\rightarrow} [ Slot \.{\rightarrow} Trans \.{\cup} \{
 NotTrans \} ] ]}%
...
\@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}} Init \.{\defeq}}%
 ...
 [ s \.{\in} Shard \.{\mapsto} [ i \.{\in} Slot \.{\mapsto} NotTrans ] ]}%
...
\@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}}\midbar\@xx{}%
 ...
 \.{\defeq}}%
\@y{\@s{0}%
 Cerify transaction \ensuremath{t \.{\in} Trans} on shard \ensuremath{s
 \.{\in} Shard
}}%
\@xx{}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sat \ensuremath{Jun} 12
 22:14:42 \ensuremath{CST} 2021 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%

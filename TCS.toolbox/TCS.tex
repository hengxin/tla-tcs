...
\@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}} Vote ( t ,\, s ,\, n )
 \.{\defeq}\@w{ABORT}}%
\@y{\@s{0}%
 \ensuremath{TODO
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}} Decision ( ms )
 \.{\defeq}\@w{ABORT}}%
\@y{\@s{0}%
 \ensuremath{TODO
}}%
...
\@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}} Certify ( t ) \.{\defeq}}%
\@y{\@s{0}%
 Certify \ensuremath{t \.{\in} Tid
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}}\@s{16.4} \.{\land}\@s{3.65}
 ...
 {\UNCHANGED} sVars}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}} Prepare ( t ,\, s )
 \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}}\@s{16.4} \.{\land}\@s{6.34}
 \E\, m \.{\in} msg \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}}\@s{37.95} \.{\land} m \.{=}
 [ type \.{\mapsto}\@w{PREPARE} ,\, t \.{\mapsto} t ,\, s \.{\mapsto} s ]}%
 \@x{\makebox[0pt][r]{\scriptsize 86\hspace{1em}}\@s{37.95} \.{\land} next
 \.{'} \.{=} [ next {\EXCEPT} {\bang} [ s ] \.{=} @ \.{+} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}}\@s{37.95} \.{\land} txn
 \.{'} \.{=} [ txn {\EXCEPT} {\bang} [ s ] [ next \.{'} [ s ] ] \.{=} t ]}%
 \@x{\makebox[0pt][r]{\scriptsize 88\hspace{1em}}\@s{37.95} \.{\land} vote
 \.{'} \.{=} [ vote {\EXCEPT} {\bang} [ s ] [ next \.{'} [ s ] ] \.{=} Vote (
 t ,\, s ,\, next \.{'} [ s ] ) ]}%
\@y{\@s{0}%
 \ensuremath{TODO
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}}\@s{37.95} \.{\land} phase
 \.{'} \.{=} [ phase {\EXCEPT} {\bang} [ s ] [ next \.{'} [ s ] ]
 \.{=}\@w{PREPARED} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}}\@s{37.95} \.{\land}
 SendAndDelete ( \{ [ type\@s{0.56} \.{\mapsto}\@w{PREPARE\_ACK} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}}\@s{139.87} s\@s{1.47}
 \.{\mapsto} s ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}}\@s{139.87} n \.{\mapsto}
 next \.{'} [ s ] ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}}\@s{139.87} t\@s{2.11}
 \.{\mapsto} t ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}}\@s{139.87} v\@s{0.71}
 \.{\mapsto} vote \.{'} [ s ] [ next \.{'} [ s ] ] ] \} ,\,}%
\@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}}\@s{119.80} \{ m \} )}%
 \@x{\makebox[0pt][r]{\scriptsize 96\hspace{1em}}\@s{16.4} \.{\land}\@s{6.34}
 {\UNCHANGED} {\langle} dec ,\, submitted {\rangle}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}} Pos ( t ,\, s )\@s{10.16}
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}}\@s{20.69} \.{\LET} m
 \.{\defeq} ChooseUnique ( msg ,\, {\LAMBDA} m \.{:} m . type
 \.{=}\@w{PREPARE\_ACK} \.{\land} m . t \.{=} t \.{\land} m . s \.{=} s )}%
\@x{\makebox[0pt][r]{\scriptsize 100\hspace{1em}}\@s{24.79} \.{\IN} m . n}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 102\hspace{1em}} PrepareAck ( t ,\, s )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 103\hspace{1em}}\@s{16.4} \.{\land} s \.{=}
 Coord [ t ]}%
 \@x{\makebox[0pt][r]{\scriptsize 104\hspace{1em}}\@s{16.4} \.{\land} \.{\LET}
 ms \.{\defeq} \{ m \.{\in} msg \.{:} m . type \.{=}\@w{PREPARE\_ACK}
 \.{\land} m . t \.{=} t \}}%
 \@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}}\@s{27.51} shards\@s{5.44}
 \.{\defeq} \{ m . s \.{:} m \.{\in} ms \}}%
 \@x{\makebox[0pt][r]{\scriptsize 106\hspace{1em}}\@s{31.61} \.{\IN} \.{\land}
 shards \.{=} TSharding ( t )}%
 \@x{\makebox[0pt][r]{\scriptsize 107\hspace{1em}}\@s{52.01} \.{\land}
 SendAndDelete ( \{ [ type\@s{0.31} \.{\mapsto}\@w{DECISION} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 108\hspace{1em}}\@s{153.93} p\@s{0.40}
 \.{\mapsto} Pos ( t ,\, shard ) ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}}\@s{153.93} d \.{\mapsto}
 Decision ( ms ) ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}}\@s{153.93} s\@s{1.23}
 \.{\mapsto} shard ] \.{:} shard \.{\in} shards \} ,\,}%
\@x{\makebox[0pt][r]{\scriptsize 111\hspace{1em}}\@s{108.22} ms )}%
 \@x{\makebox[0pt][r]{\scriptsize 112\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} {\langle} sVars ,\, submitted {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 113\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 114\hspace{1em}} Next \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 115\hspace{1em}}\@s{16.4} \.{\lor} \E\, t
 \.{\in} Tid \.{:} Certify ( t )}%
 \@x{\makebox[0pt][r]{\scriptsize 116\hspace{1em}}\@s{16.4} \.{\lor} \E\, t
 \.{\in} Tid ,\, s \.{\in} Shard \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 117\hspace{1em}}\@s{31.61} \.{\lor} Prepare
 ( t ,\, s )}%
 \@x{\makebox[0pt][r]{\scriptsize 118\hspace{1em}}\@s{31.61} \.{\lor}
 PrepareAck ( t ,\, s )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 120\hspace{1em}} Spec \.{\defeq} Init
 \.{\land} {\Box} [ Next ]_{ vars}}%
\@x{\makebox[0pt][r]{\scriptsize 121\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 12:25:10 \ensuremath{CST} 2021 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%

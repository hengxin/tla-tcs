...
\end{lcom}%
 ...
 Shard ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}} Send ( m ) \.{\defeq} msg
 \.{'} \.{=} msg \.{\cup} m}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}} Delete ( m ) \.{\defeq} msg
 \.{'} \.{=} msg \.{\,\backslash\,} m}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}} SendAndDelete ( sm ,\, dm )
 \.{\defeq} msg \.{'} \.{=} ( msg \.{\cup} sm ) \.{\,\backslash\,} dm}%
\@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}} TypeOK \.{\defeq}}%
...
\@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}} Init \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}}\@s{16.4} \.{\land} next
 \.{=} [ s \.{\in} Shard \.{\mapsto} \.{-} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}}\@s{16.4} \.{\land} txn \.{=}
 [ s \.{\in} Shard \.{\mapsto} [ i \.{\in} Slot \.{\mapsto} NotTid ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}}\@s{16.4} \.{\land} vote
 \.{=} [ s \.{\in} Shard \.{\mapsto} [ i \.{\in} Slot \.{\mapsto} {\FALSE} ]
 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}}\@s{16.4} \.{\land} dec \.{=}
 [ s \.{\in} Shard \.{\mapsto} [ i \.{\in} Slot \.{\mapsto} {\FALSE} ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}}\@s{16.4} \.{\land} phase
 \.{=} [ s \.{\in} Shard \.{\mapsto} [ i \.{\in} Slot \.{\mapsto}\@w{START} ]
 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}}\@s{16.4} \.{\land} msg \.{=}
 \{ \}}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}}\@s{16.4} \.{\land} submitted
 \.{=} \{ \}}%
\@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 86\hspace{1em}} KeyOnShard ( s ) \.{\defeq}
 \{ k \.{\in} Key \.{:} KeySharding [ k ] \.{=} s \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 88\hspace{1em}} ComputeVote ( t ,\, s ,\, n
 ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}}\@s{16.4} \.{\LET}
 cs\@s{4.86} \.{\defeq} \{ k \.{\in} Slot \.{:}}%
\@y{\@s{0}%
 committed slots before position \ensuremath{n
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}}\@s{84.84} \.{\land} k \.{<}
 n}%
 \@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}}\@s{84.84} \.{\land} phase [
 s ] [ k ] \.{=}\@w{DECIDED}}%
 \@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}}\@s{84.84} \.{\land} dec [ s
 ] [ k ] \}}%
 \@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}}\@s{36.79} ct\@s{5.50}
 \.{\defeq} \{ txn [ s ] [ k ] \.{:} k \.{\in} cs \}}%
\@y{\@s{0}%
 committed transactions
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}}\@s{36.79} fv\@s{5.63}
 \.{\defeq} \A\, k \.{\in} KeyOnShard ( s ) ,\, v \.{\in} Ver \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}}\@s{81.38} {\langle} k ,\, v
 {\rangle} \.{\in} RSet [ t ] \.{\implies} ( \A\, c \.{\in} ct \.{:} k
 \.{\in} WSet [ c ] \.{\implies} CVer [ c ] \.{\leq} v )}%
 \@x{\makebox[0pt][r]{\scriptsize 96\hspace{1em}}\@s{36.79} ps\@s{4.35}
 \.{\defeq} \{ k \.{\in} Slot \.{:}}%
\@y{\@s{0}%
 ``prepared to commit'' slots before position \ensuremath{n
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 97\hspace{1em}}\@s{84.84} \.{\land} k \.{<}
 n}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}}\@s{84.84} \.{\land} phase [
 s ] [ k ] \.{=}\@w{PREPARED}}%
 \@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}}\@s{84.84} \.{\land} vote [ s
 ] [ k ] \}}%
 \@x{\makebox[0pt][r]{\scriptsize 100\hspace{1em}}\@s{36.79} pt\@s{4.99}
 \.{\defeq} \{ txn [ s ] [ k ] \.{:} k \.{\in} ps \}}%
\@y{\@s{0}%
 ``prepared to commit'' transactions
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 101\hspace{1em}}\@s{40.89} gv \.{\defeq}
 \A\, k \.{\in} KeyOnShard ( s ) ,\, v \.{\in} Ver \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 102\hspace{1em}}\@s{81.38} \.{\land}
 {\langle} k ,\, v {\rangle} \.{\in} RSet [ t ] \.{\implies} ( \A\, p \.{\in}
 pt \.{:} k\@s{2.69} \.{\notin} WSet [ p ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 103\hspace{1em}}\@s{81.38} \.{\land} k
 \.{\in} WSet [ t ] \.{\implies} ( \A\, p \.{\in} pt \.{:} {\langle} k ,\, v
 {\rangle} \.{\notin} RSet [ p ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 104\hspace{1em}}\@s{20.5} \.{\IN} fv
 \.{\land} gv}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 106\hspace{1em}} ComputeDecision ( vs )
 \.{\defeq} \A\, v \.{\in} vs \.{:} v}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 19:39:45 \ensuremath{CST} 2021 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
